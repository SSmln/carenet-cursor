...
export default function AdminPage() {
  const [activeTab, setActiveTab] = useState<"users" | "hospitals" | "beds">(
    "users"
  );
  ...
  const [editingItem, setEditingItem] = useState<User | Hospital | Bed | null>(
    null
  );
  ...
  const formSchema = z.discriminatedUnion("type", [
    z.object({
      ...
      password: z
        ...
        .optional()
        .or(z.literal("")),
      role: z.enum(["super_admin", "hospital_admin", "nurse", "operator"], {
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="password"
                      {...field}
                      placeholder={editingItem ? "변경 시에만 입력" : ""}
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
  ...
  // 모달 열기
  const openModal = (
    type: "users" | "hospitals" | "beds",
    item?: User | Hospital | Bed
  ) => {
          ...
          item
            ? {
                ...
                licenseExpiryDate: new Date(
                  (item as Hospital).licenseExpiryDate
                )
                  .toISOString()
                  .split("T")[0],
              }
  ...
  return (
    <DashboardLayout title="관리자 페이지">
      <Tabs
        value={activeTab}
        onValueChange={(value) =>
          setActiveTab(value as "users" | "hospitals" | "beds")
        }
      >
                          ...
                          <AlertDialog>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent>
                                ...
                                >
                                  <IoPencil className="mr-2" /> 수정
                                </DropdownMenuItem>
                                <AlertDialogTrigger asChild>
                                  <DropdownMenuItem className="text-red-500">
                                    <IoTrash className="mr-2" /> 삭제
                                  </DropdownMenuItem>
                                </AlertDialogTrigger>
                              </DropdownMenuContent>
                            </DropdownMenu>
                        ...
                        <TableCell>
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              handleHospitalToggle(hospital.id, checked)
                            }
                          />
                        </TableCell>
                        <TableCell className="text-right">
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                  onClick={() =>
                                    handleDelete("hospitals", hospital.id)
                                  }
                                >
                                  삭제
                                </AlertDialogAction>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>
              {editingItem
                ? `정보 수정`
                : `새 ${watchedType === "users" ? "사용자" : watchedType === "hospitals" ? "병원" : "침대"} 추가`}
            </DialogTitle>
          </DialogHeader>
          <Form {...form}>
            <form
